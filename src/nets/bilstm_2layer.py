...
class bilstm_2layer(object):
    ...
    def create_train_data(self):
        with open(settings.DATA_PATH+self.training_data, 'rb') as f:
    ...
    def create_callbacks(self):
        csv_logger = keras.callbacks.CSVLogger(settings.LOG_PATH+self.network_name+'.csv')
        net_saver = keras.callbacks.ModelCheckpoint(settings.NET_PATH+self.network_name+"_best.h5", monitor='val_loss', verbose=1, save_best_only=True)
