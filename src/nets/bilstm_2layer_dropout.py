...
class bilstm_2layer_dropout(object):
    ...
    def __init__(self, name, training_data, n_hidden1=256, n_hidden2=256, n_classes=630, n_10_batches=1000, segment_size=15, frequency=128, batch_size=100 ):
    ...
    def create_callbacks(self):
        ...
        return [csv_logger, net_saver, tb, net_checkpoint]
