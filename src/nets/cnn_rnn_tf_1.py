...
class cnn_rnn_tf_0(object):
    ...
    def run_network(self):
        ...
        with open(os.path.join(cnn_rnn_tf_0.stngs['cluster_output_path'], (cnn_rnn_tf_0.stngs['cluster_output_train_file'] + self.date_time + '40sp.pickle')), 'wb') as f:
            pickle.dump((train_net_output, train_y_data, train_speaker_names), f, -1)
        
        with open(os.path.join(cnn_rnn_tf_0.stngs['cluster_output_path'], (cnn_rnn_tf_0.stngs['cluster_output_test_file'] + self.date_time +  '40sp.pickle')), 'wb') as f:
        ...
        cnn_rnn_tf_0.logger.info("Loading test data for GRU evaluation")
        with open(os.path.join(cnn_rnn_tf_0.stngs['cluster_output_path'], (cnn_rnn_tf_0.stngs['cluster_output_train_file'] + self.date_time + '60sp.pickle')), 'wb') as f:
            pickle.dump((train_net_output_60, train_y_data, train_speaker_names), f, -1)
        
        with open(os.path.join(cnn_rnn_tf_0.stngs['cluster_output_path'], (cnn_rnn_tf_0.stngs['cluster_output_test_file'] + self.date_time +  '60sp.pickle')), 'wb') as f:
        ...
        cnn_rnn_tf_0.logger.info("Write outcome to pickle files for clustering")
        with open(os.path.join(cnn_rnn_tf_0.stngs['cluster_output_path'], (cnn_rnn_tf_0.stngs['cluster_output_train_file'] + self.date_time + '80sp.pickle')), 'wb') as f:
            pickle.dump((train_net_output_80, train_y_data, train_speaker_names), f, -1)
        
        with open(os.path.join(cnn_rnn_tf_0.stngs['cluster_output_path'], (cnn_rnn_tf_0.stngs['cluster_output_test_file'] + self.date_time + '80sp.pickle')), 'wb') as f:
