...
#layer 2
model.add(MaxPooling2D(pool_size=pool_size, strides=(2,1), dim_ordering="th"))
#layer 3
...
model.add(Activation('relu'))
#model.add(Reshape((10*nb_classes, 1)))
#Layer 6
model.add(Dropout(0.50))
#Layer 7
model.add(Dense(10*nb_classes/2))
model.add(Activation('relu'))
model.add(Reshape((10*nb_classes/2, 1)))
#Layer 8
#model.add(Reshape(10*nb_classes, 1))
#model.add(Dense(nb_classes))
#model.add(Activation('softmax'))
# LSTM LAyer
model.add(Bidirectional(LSTM(128 , input_length = 100)))
model.add(Dense(10))
model.add(Activation('softmax'))
...
history = model.fit_generator(generator(), 128, 250, 
