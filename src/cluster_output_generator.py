...
if __name__ == "__main__":
    ...
    generate_cluster_output('kld_run20170421_add_500', 'train_speakers_40_clustering_vs_reynolds.pickle', 'kld_run20170421_add_500_train_cluster_40_sm.pickel', True, True, True)
    generate_cluster_output('kld_run20170421_add_500', 'test_speakers_40_clustering_vs_reynolds.pickle', 'kld_run20170421_add_500_test_cluster_40_sm.pickel', True, True, True)    
    generate_cluster_output('kld_run20170421_add_500', 'train_speakers_60_clustering.pickle', 'kld_run20170421_add_500_train_cluster_60.pickel', True, True, True)
    generate_cluster_output('kld_run20170421_add_500', 'test_speakers_60_clustering.pickle', 'kld_run20170421_add_500_test_cluster_60.pickel', True, True, True)
    generate_cluster_output('kld_run20170421_add_500', 'train_speakers_80_clustering.pickle', 'kld_run20170421_add_500_train_cluster_80.pickel', True, True, True)
    generate_cluster_output('kld_run20170421_add_500', 'test_speakers_80_clustering.pickle', 'kld_run20170421_add_500_test_cluster_80.pickel', True, True, True)
