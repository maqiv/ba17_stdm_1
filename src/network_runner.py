...
bi2d.bilstm_2layer_dropout('t1', 'test_data_100.pickle', n_hidden1=128, n_hidden2=128, n_classes=100, n_epoch=4000, segment_size=50)
bi2d.bilstm_2layer_dropout('t2', 'test_data_100.pickle', n_hidden1=512, n_hidden2=512, n_classes=100, n_epoch=4000, segment_size=50)
